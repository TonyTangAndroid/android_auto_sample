...
//            JSONObject jsonObj = fetchJSONFromLocal("music.json",)
    ...
    private JSONObject fetchJSONFromLocal(String fileName, Context context) throws JSONException {
        BufferedReader reader = null;
...
//            URLConnection urlConnection = new URL(urlString).openConnection();
    ...
    private MediaMetadataCompat buildSongHardcode() throws JSONException {
        String title = "Key1";
        String album = "Key1";
        String artist = "Usher";
        String genre = "Usher";
